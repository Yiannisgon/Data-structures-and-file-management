...
public class Resources {
   ...
   static String message2 = "{\"booking_id\":\"1\","
    ...
    static String ticket3 = "{\"price\":20.0,\"availability\":15,\"type\":\"VIP\",\"event_id\":2}";
    static String ticket4 = "{\"price\":10.0,\"availability\":50,\"type\":\"GeneralAdmission\",\"event_id\":2}";

    // Event 3 (Shakespeare Play - Theater)
    static String ticket5 = "{\"price\":50.0,\"availability\":30,\"type\":\"VIP\",\"event_id\":3}";
    static String ticket6 = "{\"price\":25.0,\"availability\":100,\"type\":\"GeneralAdmission\",\"event_id\":3}";

    // Event 4 (Jazz Evening - Concert)
    static String ticket7 = "{\"price\":30.0,\"availability\":20,\"type\":\"VIP\",\"event_id\":4}";
    static String ticket8 = "{\"price\":15.0,\"availability\":80,\"type\":\"GeneralAdmission\",\"event_id\":4}";

    // Event 5 (Broadway Special - Theater)
    static String ticket9 = "{\"price\":40.0,\"availability\":10,\"type\":\"VIP\",\"event_id\":5}";
    static String ticket10 = "{\"price\":20.0,\"availability\":40,\"type\":\"GeneralAdmission\",\"event_id\":5}";
