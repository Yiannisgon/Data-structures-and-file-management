...
@WebServlet(name = "EditInfoOwner", urlPatterns = {"/EditInfoOwner"})
public class EditInfoOwner extends HttpServlet {

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("Opened EditInfoOwner");
        ...
        try {
            ...
            String query = "UPDATE petowners SET password = ?, firstname = ?, lastname = ?, birthdate = ?, gender = ?, country = ?, city = ?, address = ?, personalpage = ?, job = ?, telephone = ? WHERE username = ?";
            ...
            pst.setString(12, jsonObj.getString("username"));
            //debug print
